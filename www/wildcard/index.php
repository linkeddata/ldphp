...
<dl><dt>*/</dt><dd>refers to a media type you specify in an HTTP header</dd>
<dt>?=</dt><dd>refers to a query string and is application/x-www-form-urlencoded</dd></dl>
<p>Some query string options and response (HTTP Accept) media types are combinable.</p>
